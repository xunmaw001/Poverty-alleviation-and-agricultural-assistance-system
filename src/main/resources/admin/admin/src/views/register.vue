    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">扶贫助农系统注册</h1>
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            <el-form-item label="年龄" class="input" v-if="tableName=='yonghu'">
                                <el-input v-model="ruleForm.yonghuAge" autocomplete="off" placeholder="年龄"  />
                           </el-form-item>
                        -->
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            // }
                            // yonghu 中的 年龄 判空处理
                            // if('yonghu' == this.tableName && (this.ruleForm.yonghuAge== null ||this.ruleForm.yonghuAge== "")){
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/fupinzhunong/img/back-img-bg.jpg);
