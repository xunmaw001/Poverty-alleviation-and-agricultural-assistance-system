        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='renwu'">
                    <el-form-item class="select" v-if="type!='info'"  label="任务信息" prop="renwuId">
                        <el-select v-model="ruleForm.renwuId" :disabled="ro.renwuId" filterable placeholder="请选择任务信息" @change="renwuChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='renwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="职位" prop="renwuZhiwei">
                        <el-input v-model="renwuForm.renwuZhiwei"
                ...
                <el-col :span="12"  v-if="sessionTable !='renwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="报酬" prop="renwuBaocou">
                        <el-input v-model="renwuForm.renwuBaocou"
                                  placeholder="报酬" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='renwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="工作时间" prop="renwuShijian">
                        <el-input v-model="renwuForm.renwuShijian"
                ...
                <el-col :span="12"  v-if="sessionTable !='renwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="任务" prop="renwuText">
                        <el-input v-model="renwuForm.renwuText"
                                  placeholder="任务" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="任务" prop="renwuText">
                            <el-input v-model="ruleForm.renwuText"
                                      placeholder="任务" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='renwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="起止时间" prop="renwuTime">
                        <el-input v-model="renwuForm.renwuTime"
                                  placeholder="起止时间" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="起止时间" prop="renwuTime">
                            <el-input v-model="ruleForm.renwuTime"
                                      placeholder="起止时间" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='renwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="工作地点" prop="renwuAddress">
                        <el-input v-model="renwuForm.renwuAddress"
                                  placeholder="工作地点" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='renwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="负责人" prop="renwuFuzhenr">
                        <el-input v-model="renwuForm.renwuFuzhenr"
                ...
                <el-col :span="12"  v-if="sessionTable !='renwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="联系方式" prop="renwuPhone">
                        <el-input v-model="renwuForm.renwuPhone"
                ...
                <el-col :span="12"  v-if="sessionTable !='renwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="报名信息" prop="renwuBaoming">
                        <el-input v-model="renwuForm.renwuBaoming"
                                  placeholder="报名信息" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='renwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="结束时间" prop="jieshuTime">
                        <el-input v-model="renwuForm.jieshuTime"
                ...
                <el-col :span="12"  v-if="sessionTable !='renwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="任务状态" prop="zhugtaiValue">
                        <el-input v-model="renwuForm.zhugtaiValue"
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.renwuYuyueYesnoTypes" label="审核状态" prop="renwuYuyueYesnoTypes">
                        <el-input v-model="ruleForm.renwuYuyueYesnoValue" placeholder="审核状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.renwuYuyueYesnoText" label="审核回复" prop="renwuYuyueYesnoText">
                        <span v-html="ruleForm.renwuYuyueYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    renwuId: false,
                    yonghuId: false,
                    renwuYuyueYesnoTypes: false,
                    renwuYuyueYesnoText: false,
                    insertTime: false,
                },
                ruleForm: {
                    renwuId: '',
                    yonghuId: '',
                    renwuYuyueYesnoTypes: '',
                    renwuYuyueYesnoText: '',
                    insertTime: '',
                },
                renwuYuyueYesnoTypesOptions : [],
                renwuOptions : [],
                yonghuOptions : [],
                rules: {
                   renwuId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=renwu_yuyue_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.renwuYuyueYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`renwuYuyue/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.renwuYuyueCrossAddOrUpdateFlag = false;
                                        this.parent.search();
