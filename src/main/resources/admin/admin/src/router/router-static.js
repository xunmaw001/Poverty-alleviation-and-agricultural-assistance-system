...
import huanyuan from '@/views/modules/databaseBackup/huanyuan'
    ...
    import renwuYuyue from '@/views/modules/renwuYuyue/list'
    ...
    import dictionaryRenwuYuyueYesno from '@/views/modules/dictionaryRenwuYuyueYesno/list'
    ...
    import dictionaryZhugtai from '@/views/modules/dictionaryZhugtai/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryRenwuYuyueYesno',
        name: '审核状态',
        component: dictionaryRenwuYuyueYesno
    }
    ,{
        path: '/dictionarySex',
        name: '性别类型',
    ...
    ,{
        path: '/dictionaryZhugtai',
        name: '任务状态',
        component: dictionaryZhugtai
    }
    ,{
        path: '/config',
        name: '轮播图',
